...
<xsl:template match="testsuites">
    ...
    <style type="text/css">
      ...
      h1 {
        margin: 0px 0px 5px; font: 150% verdana,arial,helvetica
      }
      h2 {
    ...
    <xsl:template name="summary">
        <h2>Summary</h2>
        <xsl:variable name="testCount" select="count(/testsuites/testsuite/testcase)"/>
        ...
        <xsl:variable name="timeCount" select="sum(/testsuites/testsuite/testcase/@time)"/>
