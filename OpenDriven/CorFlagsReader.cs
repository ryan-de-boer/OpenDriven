...
//https://gist.github.com/b0urb4k1/bda5f5ff63c7af2d451c1a84ebb69575
...
namespace ApiChange.Api.Introspection
{
  ...
  public class CorFlagsReader
  {
    ...
    public static bool Is32Bit(string folder)
    {
      string[] files = Directory.GetFiles(folder, "*.dll");
      foreach (string file in files)
      {
        ProcessorArchitecture pa = CorFlagsReader.ReadAssemblyMetadata(file).ProcessorArchitecture;
        if (pa==ProcessorArchitecture.X86)
        {
          return true;
        }
      }
